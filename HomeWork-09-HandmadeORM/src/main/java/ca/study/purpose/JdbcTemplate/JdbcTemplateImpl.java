...
import ca.study.purpose.Executor.MyDbExecutorImpl;
...
public class JdbcTemplateImpl<T> implements JdbcTemplate<T> {
    ...
    public JdbcTemplateImpl(DataSource myDataSource) {
    ...
    public void create(T obj) {
        ...
        try (Connection connection = myDataSource.getConnection()) {
            MyDbExecutorImpl<T> executor = new MyDbExecutorImpl<>(connection);
